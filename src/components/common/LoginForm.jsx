...
export default function LoginForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="w-full max-w-sm flex flex-col items-center gap-4 text-[#4B3F2F]">
      ...
      <button
        type="submit"
        className="w-full bg-[#F6C343] hover:bg-[#F5B72E] text-black font-semibold rounded-lg py-2 mt-4"
      >
        로그인
      </button>
    </form>
